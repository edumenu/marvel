         ...
         <a href="#"><img src="img/marvel.png" width="60em" class="img-responsive wow fadeInRight"/></a>
			...
			<div class="collapse navbar-collapse navbar-right" id="myNavbar">
				<ul class="nav navbar-nav">
					...
					<li><a href="characters.php" class="wow fadeInRight" data-wow-delay="1s" style="color: #d9d9d9;">Characters</a></li>
					<li><a href="#comics" class="wow fadeInRight" data-wow-delay="1s" style="color: #d9d9d9;">Comics</a></li>
...
<!--Comics-->
	<section class="comics white-color" id="comics">
		<div class="container">
		 <h3 class="section-heading wow bounceInDown" style="font-family: 'Arvo', serif; color: #66CC00;">Comics</h3>
         ...
         <button type="button" class=" wow zoomIn btn btn-success btn-lg" id="searchComics" data-wow-delay="2s" style="margin: 10 auto; background-color: #66CC00; border-radius: 15px; outline: none;">Search</button>
         <button type="button" class=" wow zoomIn btn btn-success btn-lg" id="allComics" data-wow-delay="2s" style="margin: 10 auto; background-color: #66CC00; border-radius: 15px; outline: none;">All Comics</button>
         </form>
			<div class="row">
             <div class="rowImage">
...
<div class="card">
  ...
  <div class="containerCard">
    ...
    <p><strong>IssueNumber:</strong> <span id="infoIssueNum"></span></p> 
    <p><strong>Creators:</strong> <span id="infoCreator"></span></p> 
    <p><strong>Page Count:</strong> <span id="infoPageCount"></span></p> 
    <p><strong>Isbn:</strong> <span id="infoIsbn"></span></p> 
...
<script src="scripts/comics.js" type="text/javascript"></script>
