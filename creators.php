         ...
         <a href="#"><img src="img/marvel.png" width="60em" class="img-responsive wow fadeInRight"/></a>
			...
			<div class="collapse navbar-collapse navbar-right" id="myNavbar">
				<ul class="nav navbar-nav">
					...
					<li><a href="#creators" class="wow fadeInRight" data-wow-delay="1s" style="color: #d9d9d9;">Creators</a></li>
				</ul>
			</div>
		</div>
    </nav>
...
<!--Creators-->
	<section class="creators white-color" id="creators">
		<div class="container">
		 <h3 class="section-heading wow bounceInDown" style="font-family: 'Arvo', serif; color: #66CC00;">Creators</h3>
         ...
         <button type="button" class=" wow zoomIn btn btn-success btn-lg" id="searchCreators" data-wow-delay="2s" style="margin: 10 auto; background-color: #66CC00; border-radius: 15px; outline: none;">Search</button>
        <button type="button" class=" wow zoomIn btn btn-success btn-lg" id="allCreators" data-wow-delay="2s" style="margin: 10 auto; background-color: #66CC00; border-radius: 15px; outline: none;">All Creators</button>
         </form>
			<div class="row">
   <div class="rowImage">
...
<div class="card">
  ...
  <div class="containerCard">
    ...
    <p><strong>Comics: </strong><span id="infoComics"></span></p> 
...
<!-- End of footer -->
	...
	<script src="scripts/creators.js" type="text/javascript"></script>
